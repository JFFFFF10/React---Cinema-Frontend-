...
class WeeklyRevenueReport extends Component {
  ...
  handleSubmit = (event) => {
    ...
    axios.post('https://csit-314-cinema-booking-system.vercel.app/genWeeklyRevenueReport/', { sdate, edate })
      .then(res => {
      ...
      <div className="weeklyRevenueReport">
        ...
        <form onSubmit={this.handleSubmit}>
          <label>
            ...
            <input type="date" name="sdate" value={sdate} onChange={this.handleDateChange} required />
          </label>
          <label>
            Choose the end date:
            <input type="date" name="edate" value={edate} onChange={this.handleDateChange} required />
          </label>
