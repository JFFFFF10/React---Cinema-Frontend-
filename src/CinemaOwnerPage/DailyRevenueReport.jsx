...
class DailyRevenueReport extends Component {
    ...
    handleSubmit = (event) => {
        ...
        axios.post('https://csit-314-cinema-booking-system.vercel.app/genDailyRevenueReport/', { date: date })
        .then(res => {
    ...
    return (
        <>
            <div className="dailyRevenueReport">
                ...
                <label>
                    Choose a date:
                    <input type="date" value={date} onChange={this.handleDateChange} required />
                </label>
